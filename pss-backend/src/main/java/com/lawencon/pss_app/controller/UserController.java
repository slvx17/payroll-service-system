...
public class UserController {
	...
	public ResponseEntity<LoginResDto> loginResDto(@RequestBody LoginReqDto param){
		...
		final User userOptional = userService.getByEmail(param.getEmail());
		...
		result.setId(userOptional.getId());		
		result.setToken(jwtService.generateJwt(claims));
		result.setEmail(userOptional.getEmail());
		result.setRole(userOptional.getRole().getRoleCode());		
